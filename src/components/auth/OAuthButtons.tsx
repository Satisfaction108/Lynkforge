...
export function OAuthButtons({ mode }: OAuthButtonsProps) {
  ...
  const handleOAuthSignIn = async (provider: "google" | "github") => {
    ...
    // If successful, user will be redirected to the OAuth provider
  };
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        disabled={loadingProvider !== null}
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-slate-900 bg-slate-900 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
      >
